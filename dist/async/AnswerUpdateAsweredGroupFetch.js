...
export const AnswerUpdateAsweredGroupFetch = props => (dispatch, getState) => props.questions.forEach(question => {
  question.answers.forEach(answer => {
    if (answer.user.id === props.currentUser.id) {
      AnswerUpdateAsweredMutation({
        id: answer.id,
        lastchange: answer.lastchange,
        aswered: props.aswered
